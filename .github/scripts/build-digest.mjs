...
<<<<<<< HEAD
  ...
  lines.push('');
  lines.push(`_Auto-generated by \`.github/workflows/upstream-${frequency}.yml\`. Review the releases and recent issues below; the "Skills watching this repo" column points at the skill files most likely to need edits._`);
  lines.push('');
